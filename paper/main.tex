...
AI4I~2020 is itself a simulated dataset generated from these same closed-form rules, a caveat we
return to in Section~\ref{sec:limitations}.
...
\paragraph{Code and data availability.} Code, the trained model artifacts, and the full notebook
reproducing every table and figure in this paper are available at
\url{https://github.com/kowshik24/glowing-broccoli}. AI4I~2020 is public
\citep{matzka2020explainable} and included in the repository.
